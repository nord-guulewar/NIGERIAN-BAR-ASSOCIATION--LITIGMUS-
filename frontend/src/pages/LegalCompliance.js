      ...
      <Card className="border-0 shadow-sm">
        <Card.Body className="p-4 p-md-5">
          <div className="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4">
            <div>
              <Badge bg="success" className="mb-2">Legal and Compliance</Badge>
            ...
            <Button variant="outline-success" onClick={() => navigate('/privacy')}>
              View Privacy Policy
            </Button>
          </div>
              ...
              <Col md={6} lg={4} key={policy.title}>
                <Card className="h-100 border-0 shadow-sm">
                  <Card.Body className="d-flex flex-column">
                    ...
                    <Button variant="link" className="p-0 text-decoration-none align-self-start" onClick={() => navigate(policy.route)}>
                      Open policy
                    </Button>
                  </Card.Body>
                </Card>
